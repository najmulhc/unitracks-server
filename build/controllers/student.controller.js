...
exports.studnetInputPhaseTwo =
  exports.studentInputPhaseOne =
  exports.getStudent =
    void 0;
const student_model_1 = __importDefault(require("../models/student.model"));
const ApiError_util_1 = __importDefault(require("../utils/ApiError.util"));
const ApiResponse_util_1 = __importDefault(
...
const studentInputPhaseOne = async (req, res) => {
  ...
  if (!firstName || !lastName || !dateOfBirth || !bloodGroup) {
    throw new ApiError_util_1.default(
      400,
...
const studnetInputPhaseTwo = async (req, res) => {
  ...
  if (studentWithRoll) {
    throw new ApiError_util_1.default(
      401,
      "Student already exists with this roll.",
    );
  }
  ...
  if (!sessions.includes(session)) {
    throw new ApiError_util_1.default(
      400,
      "Invalid session! please provide the correct one.",
    );
  }
