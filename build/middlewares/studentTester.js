...
const studentTester = async (req, res, next) => {
    try {
        ...
        if (!student) {
            throw new ApiError_1.default(404, "There is no student with this email.");
        }
        req.student = student;
        next();
    }
    catch (error) {
        throw new ApiError_1.default(400, error.message || "There was an error accessing your student account");
    }
};
